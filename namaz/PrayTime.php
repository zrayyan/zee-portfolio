...
class PrayTime
{
    ...
    var $daylight; 	//daylight saving yes or no
    ...
    */
    ...
    function getDatePrayerTimes($year, $month, $day, $latitude, $longitude, $timeZone, $daylight)
    {
        $this->lat = $latitude;
        $this->lng = $longitude;
        $this->timeZone = $timeZone + $daylight;
    ...
    function getPrayerTimes($timestamp, $latitude, $longitude, $timeZone, $daylight)
    {
        $date = @getdate($timestamp);
        return $this->getDatePrayerTimes($date['year'], $date['mon'], $date['mday'],
                    $latitude, $longitude, $timeZone, $daylight);
    }
