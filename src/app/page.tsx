    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      >
        <div className="container mx-auto max-w-6xl">
          ...
          <motion.div className="flex flex-col sm:flex-row sm:space-x-6 space-y-6 sm:space-y-0 overflow-x-auto py-4 snap-x snap-mandatory">
            {[
              ...
              <motion.div
                ...
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="snap-start flex-none w-full sm:w-[45vw] sm:min-w-[300px] p-6 bg-background rounded-lg border border-primary/20 hover:shadow-lg hover:shadow-primary/20 transition-all"
              >
